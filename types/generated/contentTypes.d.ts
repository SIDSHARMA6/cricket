...
export interface ApiChatChat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attachments: Schema.Attribute.Media<
      ...
      true
    >;
    channel: Schema.Attribute.String & Schema.Attribute.DefaultTo<'global'>;
...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::match.match'> &
      Schema.Attribute.Private;
    match_time: Schema.Attribute.DateTime;
    max_players: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    total_money: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPlayerProfilePlayerProfile
  ...
  attributes: {
    ...
    battingStyle: Schema.Attribute.String;
    bowlingStyle: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    >;
    stats: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<{}>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
